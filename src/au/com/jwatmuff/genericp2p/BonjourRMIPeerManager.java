 ...
 * using Bonjour to discover peers on the network.
 * 
 * @author James
 */
public class BonjourRMIPeerManager implements PeerManager {
    private static final Logger log = Logger.getLogger(BonjourRMIPeerManager.class);

    private BonjourRegistrationService registrar;
    private BonjourDiscoveryService discoverer;
