...
public class PlayerSelectionPanel extends javax.swing.JPanel implements DrawWizardWindow.Panel {
    ...
    public PlayerSelectionPanel(final TransactionalDatabase database, TransactionNotifier notifier, final Pool pool) {
    ...
    private void updateEligiblePlayerList() {
        ...
        model.clear();
        System.out.println("num eligible players: " + eligiblePlayers.size());
        System.out.println("num players in pool: " + playersInPool.size());
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Eligible Players (double click to add)");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(divisionNameLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 586, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void approveAllPlayersCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_approveAllPlayersCheckBoxActionPerformed
        if(approveAllPlayersCheckBox.isSelected()) {
            playerSelectionModel.setSelectionInterval(0, playerList.getModel().getSize());
        } else {
            playerSelectionModel.clearSelection();
        }
